    ...
    <main class="content">
        <div class="container-fluid p-0">
            @if (session('message'))
                {!! session('message') !!}
            @endif
            <h1 class="h3 mb-3"><a href="{{ route('web.user.admin.index') }}" class="btn"><i class="align-middle"
            ...
            <div class="card mb-3">
                <div class="card-body text-center">
                    ...
                    <div>
                        <a class="btn btn-warning btn-sm" href="{{ route('web.user.admin.edit', $admin->id) }}">Edit</a>
